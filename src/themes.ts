...
export const THEMES: Theme[] = [
  {
    ...
    vars: {
      ...
      r: '6px', 'r-sm': '4px', 'r-lg': '10px', glass: '0px', chrome: 'var(--surface)', gap: '11px', pad: '9px',
    },
  ...
  },
  {
    ...
    vars: {
      ...
      r: '9px', 'r-sm': '6px', 'r-lg': '13px', glass: '0px', chrome: 'var(--surface)', gap: '14px', pad: '12px',
    },
  ...
  },
  {
    ...
    vars: {
      ...
      r: '4px', 'r-sm': '3px', 'r-lg': '6px', glass: '0px', chrome: 'var(--surface)', gap: '10px', pad: '8px',
    },
  ...
  },
  {
    ...
    vars: {
      ...
      r: '11px', 'r-sm': '8px', 'r-lg': '16px', glass: '14px', chrome: 'color-mix(in srgb,var(--surface) 80%,transparent)', gap: '16px', pad: '13px',
  ...
  },
  {
    ...
    vars: {
      ...
      r: '8px', 'r-sm': '5px', 'r-lg': '12px', glass: '0px', chrome: 'var(--surface)', gap: '13px', pad: '11px',
    },
