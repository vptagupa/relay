  ...
  <div class="modal" id="settings">
    ...
    <div class="modal-body">
      ...
      <div class="set-panel" data-panel="agents">
        ...
        <div class="field"><label>Repository dependencies <span class="mut">— auto-select deps by main repo</span></label><div class="row"><select id="rdMain"></select><button class="set" id="rdSave">Save mapping</button></div><div class="iss-deps rd-deps" id="rdDeps"></div><div class="rd-list" id="rdList"></div><div class="fhint">Pick a main repo, tick the repos it depends on, and Save. When you <b>Assign</b> an issue or <b>Validate</b> a task in that repo, those dependencies are pre-selected under <code>.deps/</code> (until you customize that specific issue/task).</div></div>
